 ...
 * |---------`------`------`------`------`------`------`------`------`------`------`-------------|
 * |   MC/Esc |   A  |   S  |   D  |   F  |   G  |   H  |   J  |   K  |   L  |  ;   |   Hyper/"  |
 * |----------`------`------`------`------`------`------`------`------`------`------`------------|
 * |  Shift/(  |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |   Sft/)   |  SFT_ENT
 * |-----------`------`------`------`------`-----'-------`------`------`------`------`-----------|
 * |   Ctrl  |   Alt   |   GUI   |   Lower/Space  |   Raise/Enter  |   TC    | GUI/Lock|   GAME  |
 *  `--------+---------+---------+------^^^-------+-----^^^--------+---------+---------+---------'
 *
 */
    ...
    [_QWERTY] = LAYOUT(
        ...
        /*|--------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`-----------------|*/
        LT_MC(KC_ESC), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCOLON, ALL_T(KC_QUOT),
        /*|---------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`----------------|*/
        KC_LSPO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSPC,
        /*|----------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`---------------|*/
        KC_LCTRL, KC_LALT, KC_LGUI, LT(_RAISE, KC_SPACE), LT(_LOWER, KC_ENTER), MO(_TOUCHCURSOR), KC_RGUI, MO(_MACROS)),
    /*`-----------+---------------+---------+-------^^^------+-------^^^-------+---------+-----------------+--------------'*/
 ...
 */
    [_RAISE] = LAYOUT(
        ...
        /*|--------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`-----------------|*/
        KC_LBRC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_4, KC_5, KC_6, KC_ASTR, KC_PIPE,
        /*|---------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`----------------|*/
        KC_RBRC, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_1, KC_2, KC_3, KC_SLSH, KC_BSLS,
        /*|----------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`---------------|*/
 ...
 * |           |      |      |      |      |     |       |      |      |      |      |  REC STOP |
 * |-----------`------`------`------`------`-----'-------`------`------`------`------`-----------|
 * | PLAY 01 | PLAY 02 |         |                |                |         |         |  TOGGLE |
 *  `--------+---------+---------+------^^^-------+-----^^^--------+---------+---------+---------'
 */
    [_MACROS] = LAYOUT(
        /*,--------+-------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------.*/
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, DYN_REC_START1,
        /*|--------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`-----------------|*/
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, DYN_REC_START2,
        /*|---------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`----------------|*/
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, DYN_REC_STOP,
        /*|----------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`---------------|*/
        DYN_MACRO_PLAY1, DYN_MACRO_PLAY2, _______, _______, _______, _______, KC_LOCK, _______),
    /*`-----------+---------------+---------+-------^^^------+-------^^^-------+---------+-----------------+--------------'*/
