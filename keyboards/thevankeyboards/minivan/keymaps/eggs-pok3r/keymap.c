 ...
 *
 * ,---------+------+------+------+------+------+------+------+------+------+------+-------------.
 * |   Tab   |   Q  |   W  |   E  |   R  |   T  |   1  |   2  |   3  |   4  |   5  |      9      |
 * |---------`------`------`------`------`------`------`------`------`------`------`-------------|
 * |    Esc   |   A  |   S  |   D  |   F  |   G  |   F1  |  F2 |  F3  |  F4  |  F5  |      0     |
 * |----------`------`------`------`------`------`------`------`------`------`------`------------|
 * |   Shift   |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |    Ent    |
 * |-----------`------`------`------`------`-----'-------`------`------`------`------`-----------|
 * |   Ctrl  |   GUI   |   ALT   |      Space     |      Enter     |         |         | DEFAULT |
 *  `--------+---------+---------+------^^^-------+-----^^^--------+---------+---------+---------'
 */
 ...
 * |-----------`------`------`------`------`-----'-------`------`------`------`------`-----------|
 * |   Alt   |   GUI   |  Lower  |    TC/Space    |   TC/Enter     |  Raise  |   Vol+  |  Play   |
 *  `--------+---------+---------+------^^^-------+-----^^^--------+---------+---------+---------'
 */
 ...
 * |---------`------`------`------`------`------`------`------`------`------`------`-------------|
 * |   MC/Esc |   A  |   S  |   D  |   F  |   G  |   H  |   J  |   K  |   L  |  ;   |      "     |  Extra GUI + Extra Alt
 * |----------`------`------`------`------`------`------`------`------`------`------`------------|
 * |   Shift   |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |  Sft/Ent  |
 * |-----------`------`------`------`------`-----'-------`------`------`------`------`-----------|
 * |   Ctrl  |   GUI   |   Alt   |   Lower/Space  |   Raise/Enter  |   TC    |         |   GAME  |  Vol+ + Play
 *  `--------+---------+---------+------^^^-------+-----^^^--------+---------+---------+---------'
 *
 */
 ...
 * |   MC/Esc |   A  |   S  |   D  |   F  |   G  |   H  |   J  |   K  |   L  |  ;   |      "     |  Extra GUI + Extra Alt
 * |----------`------`------`------`------`------`------`------`------`------`------`------------|
 * |   Shift   |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |  Sft/Ent  |  SFT_ENT
 * |-----------`------`------`------`------`-----'-------`------`------`------`------`-----------|
 * |   Ctrl  |   GUI   |   Alt   |   Lower/Space  |   Raise/Enter  |   TC    |         |   GAME  |  Vol+ + Play
 *  `--------+---------+---------+------^^^-------+-----^^^--------+---------+---------+---------'
 *
 */
    ...
    [_QWERTY] = KEYMAP(
        ...
        /*|----------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`---------------|*/
        KC_LCTRL, KC_LGUI, KC_LALT, LT(_LOWER, KC_SPACE), LT(_RAISE, KC_ENTER), MO(_TOUCHCURSOR), KC_RGUI, TT(_GAME)),
    /*`-----------+---------------+---------+-------^^^------+-------^^^-------+---------+-----------------+--------------'*/
 ...
 */
    ...
    //     /*|----------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`---------------|*/
    //     KC_LALT, KC_LGUI, LOWER, LT_TC, LT_TCE, RAISE, _______, _______),
    /*`-----------+---------------+---------+-------^^^------+-------^^^-------+---------+-----------------+--------------'*/
 ...
 */
    [_LOWER] = KEYMAP(
        ...
        /*|----------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`---------------|*/
        BL_STEP, _______, _______, _______, _______, _______, _______, _______),
    /*`-----------+---------------+---------+-------^^^------+-------^^^-------+---------+-----------------+--------------'*/
 ...
 */
    [_RAISE] = KEYMAP(
        ...
        /*|----------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`---------------|*/
        BL_TOGG, _______, _______, _______, _______, _______, _______, _______),
    /*`-----------+---------------+---------+-------^^^------+-------^^^-------+---------+-----------------+--------------'*/
 ...
 */
    ...
    /* Pok3r Mouse Layer
 * ,---------+------+------+------+------+------+------+------+------+------+------+-------------.
 * |         |      |ACCL0 |ACCL1 |ACCL2 |ACCL3 |      |WHL_L |  Up  |WHL_R | BTN2 |             |
 * |---------`------`------`------`------`------`------`------`------`------`------`-------------|
 * |          |      |      |      | BTN1 | BTN2 |WHL_Up| Left | Down |Right | BTN4 |   BTN5     |
 * |----------`------`------`------`------`------`------`------`------`------`------`------------|
 * |           |      |      |      | BTN3 |      |WHL_Dn| BTN1 |      |      | BTN3 |           |
 * |-----------`------`------`------`------`-----'-------`------`------`------`------`-----------|
 * |         |         |         |                |                |         |         |         |
 ...
 */
    ...
    [_MOUSECURSOR] = KEYMAP(
        ...
        /*|---------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`----------------|*/
        KC_LOCK, _______, _______, _______, _______, _______, KC_WH_D, KC_BTN1, KC_WH_L, KC_WH_R, KC_BTN3, _______,
        /*|----------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`---------------|*/
        LGUI(S(KC_4)), _______, _______, _______, _______, _______, _______, _______),
    /*`-----------+---------------+---------+-------^^^------+-------^^^-------+---------+-----------------+--------------'*/
 ...
 */
    ...
    [_GAME] = KEYMAP(
        ...
        /*|----------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`---------------|*/
        KC_LCTRL, KC_LGUI, KC_LALT, KC_SPACE, KC_ENTER, MO(_TOUCHCURSOR), RESET, TT(_GAME)),
