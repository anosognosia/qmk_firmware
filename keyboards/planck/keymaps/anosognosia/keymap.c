 ...
 * |----------`------`------`------`------`------`------`------`------`------`------`------------|
 * |  Shift/( |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |  Shift/)   |  SFT_ENT
 * |-----------`------`------`------`------`-----'-------`------`------`------`------`-----------|
 * |   Ctrl  |  LGUI   |   Alt   |   Raise/Space  |   Lower/Enter  |   TC    |   RGUI  |   GAME  |  Vol+ + Play
 *  `--------+---------+---------+------^^^-------+-----^^^--------+---------+---------+---------'
 *
 */
 ...
 * |----------+------+------+------+------+------------+-----------+------+------+------+------+--------|
 * |   Hyper  | Ctrl | LGUI | Alt  |      | Raise/Space|Lower/Enter|  MC  |  TC  | RGUI |      |  GAME  |
 * `----------------------------------------------------------------------------------------------------'
 */

[_QWERTY] = {
  {KC_TAB, KC_Q,    KC_W,     KC_E,    KC_R,    KC_T,    KC_Y,                   KC_U,                   KC_I,               KC_O,    KC_P,    KC_BSPC},
  {LT_MC(CTL_ESC),  KC_A,     KC_S,    KC_D,    KC_F,    KC_G,                   KC_H,                   KC_J,               KC_K,    KC_L,    KC_SCOLON, KC_QUOT},
  {KC_LSPO,         KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,                   KC_N,                   KC_M,               KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC},
  {KC_HYPR, KC_LCTRL, KC_LGUI, KC_LALT, LT(_RAISE, KC_SPACE), LT(_RAISE, KC_SPACE),   LT(_LOWER, KC_ENTER),   LT(_LOWER, KC_ENTER),   MO(_TOUCHCURSOR), KC_RGUI, _______, MO(_ADJUST)} //TT(_GAME)
},
...
[_MOUSECURSOR] = {
  {_______, KC_MRWD, KC_MPLY, KC_MFFD, KC_ACL0, KC_ACL1, KC_ACL2, KC_BTN1, KC_MS_U, KC_WH_R, KC_BTN2, _______},
  ...
  {LGUI(S(KC_4)), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______}
},
